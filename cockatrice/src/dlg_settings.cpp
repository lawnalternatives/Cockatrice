...
#define WIKI_CUSTOM_PIC_URL "https://github.com/lawnalternatives/Commatrice/wiki/Custom-Picture-Download-URLs"
#define WIKI_CUSTOM_SHORTCUTS "https://github.com/lawnalternatives/Commatrice/wiki/Custom-Keyboard-Shortcuts"
    ...
    switch (loadStatus) {
        ...
        case NotLoaded:
            loadErrorMessage = tr("Your card database did not finish loading\n\n"
                                  "Please file a ticket at https://github.com/lawnalternatives/Commatrice/issues with your "
                                  "cards.xml attached\n\n"
                                  "Would you like to change your database location setting?");
            break;
        case FileError:
